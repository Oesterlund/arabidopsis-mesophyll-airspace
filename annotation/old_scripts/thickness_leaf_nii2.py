...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  4 13:43:23 2023
...
def lenLeaf(path,nameF):
    ...
    #remove half of slices to check values
    sCt = imgCt.shape
    imgCt= imgCt[0:int(sCt[0]/2)]
...
col0_021 = lenLeaf(path="/home/isabella/Documents/PLEN/x-ray/annotation/baseline/04-v3/",nameF="021_col0_w3_p1_l7b_2_zoomed-0.25.nii.gz")
#(0.35262023272257637, 0.105633175189906, 89.45123443658622)
# old (0.3660322688289664, 0.10931924590595517, 90.19398363282338)
col0_022 = lenLeaf(path="/home/isabella/Documents/PLEN/x-ray/annotation/baseline/04-v3/",nameF="022_col0_w3_p1_l7m_zoomed-0.25.nii.gz")
#(0.34602634670362664, 0.0987454828243774, 86.53276748716138)
# old (0.3503518097231859, 0.10026059437057126, 87.29514446811518)
...
savepath='/home/isabella/Documents/PLEN/x-ray/annotation/leaf_size/calculated_half_vol/'
...
plt.figure(figsize=(10,7))
plt.plot(xaxis,w3p0l6PL,label='week3 p0 leaf 6',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p0l8PL,label='week3 p0 leaf 8',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p1l6PL,label='week3 p1 leaf 6',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p1l7PL,label='week3 p1 leaf 7',alpha=.7,marker='s',linestyle='dashed')
...
plt.figure(figsize=(10,7))
plt.plot(xaxis,w6p1l6PL,label='week5 p1 leaf 6',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p2l6PL,label='week5 p2 leaf 6',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p1l7PL,label='week5 p1 leaf 7',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p2l7PL,label='week5 p2 leaf 7',alpha=.7,marker='o',linestyle='dashed')
...
plt.figure(figsize=(10,7))
plt.plot(xaxis,w3p0l6AS,label='week3 p0 leaf 6',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p0l8AS,label='week3 p0 leaf 8',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p1l6AS,label='week3 p1 leaf 6',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p1l7AS,label='week3 p1 leaf 7',alpha=.7,marker='s',linestyle='dashed')
...
plt.figure(figsize=(10,7))
plt.plot(xaxis,w6p1l6AS,label='week5 p1 leaf 6',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p2l6AS,label='week5 p2 leaf 6',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p1l7AS,label='week5 p1 leaf 7',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p2l7AS,label='week5 p2 leaf 7',alpha=.7,marker='o',linestyle='dashed')
...
plt.figure(figsize=(10,7))
plt.plot(xaxis,w3p0l6L,label='week3 p0 leaf 6',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p0l8L,label='week3 p0 leaf 8',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p1l6L,label='week3 p1 leaf 6',alpha=.7,marker='s',linestyle='dashed')
plt.plot(xaxis,w3p1l7L,label='week3 p1 leaf 7',alpha=.7,marker='s',linestyle='dashed')
...
plt.figure(figsize=(10,7))
plt.plot(xaxis,w6p1l6L,label='week5 p1 leaf 6',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p1l7L,label='week5 p1 leaf 7',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p2l6L,label='week5 p2 leaf 6',alpha=.7,marker='o',linestyle='dashed')
plt.plot(xaxis,w6p2l7L,label='week5 p2 leaf 7',alpha=.7,marker='o',linestyle='dashed')
